    ...
    public class Pathes
    {
        ...
        public class GearItemDrop
        {
            ...
            public static void Prefix(GearItem __instance, int numUnits)
            {
                ...
                MelonLogger.Msg("Item dropped " + MyMod.GetGearName(__instance));
        ...
        private static class CookingPotItem_StartCooking
        {
            internal static void Prefix(CookingPotItem __instance, GearItem gearItemToCook)
            {
                ...
                {
                    MelonLogger.Msg("Going to cook " + MyMod.GetGearName(gearItemToCook) + " IgnoreDropOverride");
            ...
            internal static void Postfix(GearItem __instance)
            {
                ...
                if(MyMod.IsUserGeneratedHandItem(__instance.name))
                {
                    if (__instance.m_ObjectGuid != null)
                    {
                        ...
                        Texture2D tex = MPSaveManager.GetPhotoTexture(__instance.m_ObjectGuid.m_Guid, MyMod.GetGearName(__instance));
                        if (tex)
                        {
            ...
            internal static void Postfix(ResearchItem __instance, float timeOfDayHours)
            {
                ...
                if (__instance.gameObject.GetComponent<GearItem>() != null)
                {
                    ...
                    if (gi.m_ObjectGuid)
                    {
                        ...
                        MelonLogger.Msg("Have read book " + MyMod.GetGearName(gi) + " GUID " + Key + " Progress "+__instance.m_ElapsedHours+"/"+ __instance.m_TimeRequirementHours);
        ...
        private static class ClothingSlot_SetPaperDollTexture
        {
            internal static void Postfix(ClothingSlot __instance, GearItem gi)
            {
                ...
                if (gi && gi.m_ClothingItem && !string.IsNullOrEmpty(gi.m_ClothingItem.m_PaperDollTextureName)  && MyMod.GetGearName(gi) == "GEAR_CookingPot")
                    {
        ...
        private static class Inventory_Pickup
        {
            internal static void Prefix(PlayerManager __instance, GearItem pickupItem)
            {
                ...
                {
                    MelonLogger.Msg("Pickedup " + MyMod.GetGearName(pickupItem));
                    ...
                    string GearName = MyMod.GetGearName(pickupItem);
            ...
            internal static void Postfix(PlayerManager __instance, GameObject interactiveObject, ref string __result)
            {
                ...
                if (interactiveObject != null)
                {
                    if (interactiveObject.GetComponent<Comps.MultiplayerPlayer>() != null)
                    {
                        ...
                        if (GameManager.GetPlayerManagerComponent().m_ItemInHands && MyMod.IsCustomHandItem(MyMod.GetGearName(GameManager.GetPlayerManagerComponent().m_ItemInHands)))
                        {
                            __result = PlayerName;
                            return;
                        }
                ...
                if (__result == true)
                {
                    ...
                    if (__instance.gameObject != null)
                    {
                        ...
                        for (int index = 0; index < __instance.m_Items.Count; ++index)
                        {
                            ...
                            if (gearItem != null)
                            {
                                if (MyMod.GetGearName(gearItem).Contains("MountainTownFarmKey") == true)
                                {
                                    return;
                                }
                            }
        ...
        public static class Fire_AddFuel
        {
            public static void Postfix(Fire __instance, GearItem fuel)
            {
                ...
                {
                    MelonLogger.Msg("[Fire][AddFuel] " + __instance.gameObject.name + " fuel is " + MyMod.GetGearName(fuel));
                }
                ...
                {
                    MelonLogger.Msg("Added fuel to fire " + MyMod.GetGearName(fuel));
                    MyMod.SendMyFire(__instance, MyMod.GetGearName(fuel));
                }
            }
        }
            ...
            private static bool Prefix(PlayerManager __instance, GearItem gi, ref bool __result)
            {
                ...
                if(fpsMeshId == -1)
                {
                    ...
                    if (GameManager.GetVpFPSCamera().CurrentWeaponID == fpsMeshId)
                    {
                        ...
                        {
                            if(MyMod.GetGearName(GameManager.GetPlayerManagerComponent().m_ItemInHands) == MyMod.GetGearName(gi))
                            {
                                __result = false;
                                return false;
                            }else{
        ...
        private static class Utils_GetInventoryIconTexture
        {
            private static void Postfix(Utils __instance, GearItem gi, ref Texture2D __result)
            {
                ...
                if (!MyMod.VanilaRadio && MyMod.GetGearName(gi) == "GEAR_HandheldShortwave")
                {
